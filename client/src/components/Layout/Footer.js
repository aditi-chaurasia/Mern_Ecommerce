  ...
  return (
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-10 gap-y-12 gap-x-8 xl:gap-x-12">
            <div class="col-span-3 md:col-span-4 xl:pr-8">
                <div className='font-bold text-2xl cursor-pointer flex items-center gap-1'>
                <TiShoppingCart className='w-7 h-7 text-blue-600'/>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <p class="text-sm text-gray-600">© Copyright 2024, All Rights Reserved by TrendyCart</p>

            <ul class="flex items-center mt-2 space-x-3 md:order-3 sm:mt-0">
                <li>
                    <a
                        href="#"
                        title=""
